...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->boolean('is_invited')->default(false)->after('invitation_accepted_at');
        });
    }
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropColumn(['invitation_token', 'invitation_sent_at', 'invitation_accepted_at', 'is_invited']);
        });
    }
};