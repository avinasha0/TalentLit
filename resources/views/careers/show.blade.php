                ...
                <div class="text-center">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-6 text-indigo-100 mb-8">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span>{{ $job->globalLocation?->name ?? $job->city?->formatted_location ?? 'No location specified' }}</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{ $job->globalLocation?->name ?? $job->city?->formatted_location ?? 'No location specified' }}</p>
                                </div>
                            </div>
                        </div>
