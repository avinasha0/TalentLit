...
<div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <form id="footer-newsletter-form" method="POST" action="{{ route('newsletter.subscribe') }}" class="max-w-md mx-auto">
                @csrf
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <input type="email" 
                           ...
                           required>
                    <button type="submit" 
                            class="bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-200">
                        Subscribe
                    </button>
                </div>
                ...
                <!-- Error Message -->
                <div id="footer-recapError" class="text-red-200 text-sm mt-2 text-center" style="display:none;"></div>
            </form>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    footerForm.addEventListener('submit', function(e) {
        console.log('Footer newsletter form submitted - checking reCAPTCHA...');
        ...
        if (!recaptchaToken) {
            ...
            // Show error message
            const errorDiv = document.getElementById('footer-recapError');
            if (errorDiv) {
