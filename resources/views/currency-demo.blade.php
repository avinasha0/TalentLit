    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-2">
                    <p><strong>Currency Code:</strong> @currentCurrency</p>
                    <p><strong>Currency Symbol:</strong> @currencySymbol</p>
                    <p><strong>Tenant Location:</strong> {{ tenant()->location ?? 'Not set' }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between">
                        ...
                        <span class="font-mono">@currency(50000)</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Salary Range:</span>
                        <span class="font-mono">@currencyRange(50000, 80000)</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Large Amount:</span>
                        <span class="font-mono">@currency(1500000)</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Small Amount:</span>
                        <span class="font-mono">@currency(1500)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between">
                        <span>Single Amount:</span>
                        <span class="font-mono">@currency(50000, 'USD')</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Salary Range:</span>
                        <span class="font-mono">@currencyRange(50000, 80000, 'USD')</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Large Amount:</span>
                        <span class="font-mono">@currency(1500000, 'USD')</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between">
                        <span>Single Amount:</span>
                        <span class="font-mono">@currency(50000, 'INR')</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Salary Range:</span>
                        <span class="font-mono">@currencyRange(50000, 80000, 'INR')</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Large Amount:</span>
                        <span class="font-mono">@currency(1500000, 'INR')</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 bg-blue-50 rounded-lg p-6">
            ...
            <div class="space-y-2 text-sm">
                ...
                <ul class="list-disc list-inside space-y-1 ml-4">
                    <li><code>@currency($amount)</code> - Format amount</li>
                    <li><code>@currencySymbol</code> - Display currency symbol</li>
                    <li><code>@currentCurrency</code> - Display currency code</li>
                </ul>
            </div>
        </div>
    </div>
