...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Thank you for your interest in joining {{ $tenant->name }}!</p>
        </div>

        <div class="content">
            <p>Dear {{ $candidate->first_name }} {{ $candidate->last_name }},</p>

            <p>We have successfully received your application for the position of <strong>{{ $job->title }}</strong> at {{ $tenant->name }}.</p>
            ...
            <p>Thank you again for your interest in {{ $tenant->name }}!</p>
