        ...
        <div class="content">
            ...
            <div class="interview-details">
                ...
                @if($interview->meeting_link)
                    <div class="detail-row">
                        ...
                        <span class="value">
                            <a href="{{ $interview->meeting_link }}" style="color: #4f46e5;">{{ $interview->meeting_link }}</a>
                        </span>
                    </div>
                @endif
                ...
                @if($interview->notes)
                    <div class="detail-row">
                        ...
                        <span class="value">{{ $interview->notes }}</span>
                    </div>
                @endif
            </div>
            ...
            @if($interview->meeting_link)
                <div style="text-align: center;">
                    <a href="{{ $interview->meeting_link }}" class="button">Join Meeting</a>
                </div>
            @endif
