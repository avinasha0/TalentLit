...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>A new candidate has applied for a position at {{ $tenant->name }}!</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="candidate-info">
                ...
                <p><strong>Email:</strong> {{ $candidate->primary_email }}</p>
                <p><strong>Phone:</strong> {{ $candidate->primary_phone ?? 'Not provided' }}</p>
            </div>
            ...
            <ul>
                ...
                <li><strong>Location:</strong> {{ $job->location?->name ?? $job->globalLocation?->name ?? $job->city?->formatted_location ?? 'No location specified' }}</li>
            ...
            <p><a href="{{ route('tenant.jobs.pipeline', ['tenant' => $tenant->slug, 'job' => $job->slug]) }}" class="button">View in Pipeline</a></p>

            <p>Please review this application in the recruitment pipeline and take appropriate action.</p>
        </div>

        <div class="footer">
            <p>This is an automated notification from {{ $tenant->name }} Careers.</p>
