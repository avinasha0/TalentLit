                            ...
                            <div class="grid grid-cols-2 gap-8 px-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <a href="{{ route('features.career-site') }}" class="block px-3 py-2 text-sm text-indigo-600 bg-indigo-50 rounded-md transition-colors duration-200">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
                    ...
                    <div class="px-3 py-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('features.career-site') }}" class="block px-3 py-2 text-base text-indigo-600 bg-indigo-50 rounded-md">
                                Career Site
                            </a>
