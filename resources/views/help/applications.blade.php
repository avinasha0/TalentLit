...
@section('title', 'Application Management — TalentLit Help')
@section('description', 'Learn how to manage job applications, track candidate progress, and update application statuses in TalentLit ATS.')
