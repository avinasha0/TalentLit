...
@section('title', 'Dashboard Overview — TalentLit Help')
@section('description', 'Learn how to use the TalentLit dashboard to track your hiring metrics, manage applications, and monitor team activity.')
