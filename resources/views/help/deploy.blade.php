...
@section('title', 'Deployment Guide — TalentLit Help')
@section('description', 'Learn how to deploy TalentLit ATS on your own server, including hosting setup, configuration, and maintenance.')
