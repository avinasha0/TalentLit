...
@section('title', 'Frequently Asked Questions — TalentLit')
@section('description', 'Find answers to common questions about TalentLit ATS. Get help with account setup, features, and troubleshooting.')
            ...
            <div class="space-y-8">
                ...
                <div class="bg-indigo-50 p-8 rounded-lg">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('help.page', 'contact') }}" class="bg-indigo-600 text-white px-6 py-3 rounded-md font-medium hover:bg-indigo-700 transition-colors">
                            Contact Support
                        </a>
                        <a href="{{ route('help.index') }}" class="bg-white text-indigo-600 px-6 py-3 rounded-md font-medium border border-indigo-600 hover:bg-indigo-50 transition-colors">
                            Browse Help Center
                        </a>
                    </div>
                </div>
