...
@section('title', 'Integrations — TalentLit Help')
@section('description', 'Learn how to integrate TalentLit ATS with other tools and services to streamline your hiring process and improve productivity.')
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li><a href="{{ route('help.page', 'deploy') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">Deployment Guide</a></li>
