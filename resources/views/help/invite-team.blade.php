...
@section('title', 'Invite Team Members — TalentLit')
@section('description', 'Learn how to invite team members to your TalentLit organization and manage user permissions.')
            ...
            <div class="space-y-8">
                ...
                <div class="bg-indigo-50 p-8 rounded-lg">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="{{ route('help.page', 'settings') }}" class="bg-white text-indigo-600 px-6 py-3 rounded-md font-medium border border-indigo-600 hover:bg-indigo-50 transition-colors">
                            Settings Help
                        </a>
                    </div>
                </div>
