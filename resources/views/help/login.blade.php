...
@section('title', 'How to Login — TalentLit Help')
@section('description', 'Learn how to sign in to your TalentLit account and troubleshoot common login issues.')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('login') }}" class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg">
                        Sign In
                    </a>
                </div>
            </div>
                    ...
                    <div class="max-w-none">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg mb-8">
                            ...
                            <ul class="space-y-2 text-gray-600">
                                ...
                                <li>• Visit <code class="bg-gray-200 px-2 py-1 rounded text-sm">{{ url('/login') }}</code> directly</li>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <img src="{{ asset('images/help/login-step1.png') }}" alt="Login page access" class="w-full rounded-lg shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-8">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800">Screenshot</h3>
                                    <div class="mt-2 text-sm text-blue-700">
                                        <img src="{{ asset('images/help/login-step2.png') }}" alt="Login form" class="w-full rounded-lg shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border border-gray-200 rounded-lg p-6">
                                ...
                                <ul class="space-y-3 text-gray-600">
                                    ...
                                    <li class="flex items-start">
                                        ...
                                        <div>
                                            <strong>Direct URL:</strong> Visit <code class="bg-gray-200 px-2 py-1 rounded text-sm">{{ url('/logout') }}</code> to logout
                                        </div>
                                    </li>
                                    <li class="flex items-start">
                        ...
                        <div id="related-topics" class="bg-indigo-50 p-8 rounded-lg">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('help.page', 'register') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">How to Register</a></li>
                                        <li><a href="{{ route('help.page', 'onboarding') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">Account Setup</a></li>
