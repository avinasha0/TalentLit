...
@section('title', 'Account Setup & Onboarding — TalentLit Help')
@section('description', 'Complete guide to setting up your TalentLit account, creating your organization, and getting started with your first job posting.')
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <img src="{{ asset('images/help/onboarding-step1.png') }}" alt="Organization creation form" class="w-full rounded-lg shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-8">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800">Screenshot</h3>
                                    <div class="mt-2 text-sm text-blue-700">
                                        <img src="{{ asset('images/help/onboarding-step3.png') }}" alt="Job creation form" class="w-full rounded-lg shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="related-topics" class="bg-indigo-50 p-8 rounded-lg">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('help.page', 'jobs') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">Managing Jobs</a></li>
                                        <li><a href="{{ route('help.page', 'candidates') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">Managing Candidates</a></li>
