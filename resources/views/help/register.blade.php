...
@section('title', 'How to Register — TalentLit Help')
@section('description', 'Learn how to create a new TalentLit account and get started with your recruitment process.')
                    ...
                    <div class="max-w-none">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg mb-8">
                            ...
                            <ul class="space-y-2 text-gray-600">
                                ...
                                <li>• Visit <code class="bg-gray-200 px-2 py-1 rounded text-sm">{{ url('/register') }}</code> directly</li>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <img src="{{ asset('images/help/register-step1.png') }}" alt="Registration page access" class="w-full rounded-lg shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-8">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800">Screenshot</h3>
                                    <div class="mt-2 text-sm text-blue-700">
                                        <img src="{{ asset('images/help/register-step2.png') }}" alt="Registration form" class="w-full rounded-lg shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="related-topics" class="bg-indigo-50 p-8 rounded-lg">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('help.page', 'login') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">How to Login</a></li>
                                        <li><a href="{{ route('help.page', 'onboarding') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">Account Setup Guide</a></li>
                                        <li><a href="{{ route('help.page', 'jobs') }}" class="text-indigo-600 hover:text-indigo-700 font-medium">Creating Your First Job</a></li>
                                    </ul>
                                </div>
                                <div>
