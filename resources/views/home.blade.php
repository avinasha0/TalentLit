<x-guest-layout>
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                            ...
                            <span class="block text-primary-600 dark:text-primary-400 xl:inline">Modern ATS for Growing Teams</span>
                        </h1>
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            ...
                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a href="{{ route('login') }}" 
                                   class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-primary-700 bg-primary-100 hover:bg-primary-200 md:py-4 md:text-lg md:px-10 dark:bg-primary-900/20 dark:text-primary-300 dark:hover:bg-primary-900/30">
                                    Sign In
                                </a>
                            </div>
                        </div>
    ...
    <section class="py-12 bg-gray-50 dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">
            ...
            <div class="mt-20">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-6 text-lg font-medium text-gray-900 dark:text-white">Post Jobs</h3>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-6 text-lg font-medium text-gray-900 dark:text-white">Track Candidates</h3>
                        <p class="mt-2 text-base text-gray-500 dark:text-gray-400">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-6 text-lg font-medium text-gray-900 dark:text-white">Automate Workflows</h3>
                        <p class="mt-2 text-base text-gray-500 dark:text-gray-400">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <div class="bg-primary-50 dark:bg-primary-900/20 rounded-2xl px-6 py-16 sm:px-16 text-center">
