        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
                    <!-- Email Form -->
                    <form id="email-form" method="POST" action="{{ route('newsletter.subscribe.post') }}" class="space-y-6">
                        @csrf
                    ...
                    <form id="otp-form" method="POST" action="{{ route('newsletter.verify-otp.post') }}" class="space-y-6 hidden">
                        @csrf
                ...
                <div class="text-center mt-8">
                    <a href="{{ route('home') }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-semibold">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    emailForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('{{ route("newsletter.subscribe.post") }}', {
                method: 'POST',
                headers: {
    ...
    otpForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('{{ route("newsletter.verify-otp.post") }}', {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
    ...
    if (resendBtn) {
        resendBtn.addEventListener('click', async function() {
            ...
            try {
                ...
                const response = await fetch('{{ route("newsletter.resend-otp.post") }}', {
                    method: 'POST',
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest'
                    },
