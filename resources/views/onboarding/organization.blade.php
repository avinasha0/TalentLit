    ...
    <form class="space-y-6" action="{{ route('onboarding.organization.store') }}" method="POST">
        ...
        <div>
            ...
            <input id="name" name="name" type="text" required
                class="mt-1 block w-full rounded-lg border-gray-600 bg-gray-900/50 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2"
        ...
        <div>
            ...
            <div class="flex rounded-lg shadow-sm">
                ...
                <input id="slug" name="slug" type="text" required
                    class="flex-1 min-w-0 block w-full rounded-none rounded-r-lg border-gray-600 bg-gray-900/50 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2"
