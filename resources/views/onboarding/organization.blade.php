            ...
            <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="md:hidden">
                <div class="px-4 py-4 space-y-3 bg-white border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('features.candidate-sourcing') }}" class="block px-3 py-3 text-base text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                                Candidate Sourcing
                            </a>
                            <a href="{{ route('features.hiring-pipeline') }}" class="block px-3 py-3 text-base text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                                Hiring Pipeline
                            </a>
                        </div>
                    </div>
                    ...
                    <!-- Other Links -->
                    <div class="space-y-2">
                        <a href="{{ route('subscription.pricing') }}" class="block px-3 py-3 text-base text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                            Pricing
                        </a>
            ...
            <div class="mt-8 text-center">
                ...
                <div class="mt-6 px-4">
                    <p class="text-sm text-gray-600 leading-relaxed">
                        ...
                        <a href="{{ route('contact') }}" class="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">
