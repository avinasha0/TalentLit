@php
    ...
    $breadcrumbs = [
        ...
        ['label' => 'Approved Requisitions', 'url' => null]
    ];
@endphp
...
<x-app-layout :tenant="$tenant">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4">
                <h1 class="text-2xl font-bold text-black">Approved Requisitions</h1>
                <p class="mt-1 text-sm text-black">Requisitions that have been approved</p>
            </div>
        </div>
        ...
        <x-card>
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-lg leading-6 font-medium text-black">
                    {{ $requisitions->total() }} approved requisition{{ $requisitions->total() !== 1 ? 's' : '' }}
                </h3>
            </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">No approved requisitions</h3>
                    <p class="mt-1 text-sm text-gray-500">Approved requisitions will appear here.</p>
                </div>
            @endif
        </x-card>
    </div>
