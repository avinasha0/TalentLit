                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 leading-relaxed">
                                            Configure a custom subdomain to access your dashboard at <span class="font-mono font-semibold text-purple-700">your-company.{{ parse_url(config('app.url'), PHP_URL_HOST) ?? 'example.com' }}</span>. You'll still be able to access via the standard path-based URL as well.
                                        </p>
                                    </div>
                                </div>
                            </div>
