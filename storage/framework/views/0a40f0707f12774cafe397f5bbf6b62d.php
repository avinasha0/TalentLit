            ...
            <div class="rounded-md bg-red-50 p-4">
                <div class="flex">
                    <div class="ml-3">
                        ...
                        <?php if(session('exception_message')): ?>
                            <p class="mt-1 text-xs text-red-600"><?php echo e(session('exception_message')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-2">
                    <?php $__currentLoopData = session('import_failures'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-sm text-gray-700">
                            <span class="font-semibold">Row <?php echo e($failure['row'] ?? '?'); ?>:</span>
                            <span class="text-red-600"><?php echo e(implode('; ', (array)($failure['errors'] ?? []))); ?></span>
                        </div>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <form action="<?php echo e(route('tenant.candidates.import.store', $tenant->slug)); ?>" 
                          method="POST" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="source" 
                                   id="source" 
                                   value="<?php echo e(old('source', 'Import')); ?>"
...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo e(route('tenant.candidates.import.template', $tenant->slug)); ?>" 
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/tenant/candidates/import.blade.php ENDPATH**/ ?>