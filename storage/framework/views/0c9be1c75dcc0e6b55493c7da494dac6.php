<?php $__env->startSection('title', 'Analytics & Reports — TalentLit Help'); ?>
<?php $__env->startSection('description', 'Learn how to use TalentLit analytics to track hiring metrics, generate reports, and make data-driven recruitment decisions.'); ?>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li><a href="<?php echo e(route('help.page', 'jobs')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Job Management</a></li>
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/help/analytics.blade.php ENDPATH**/ ?>