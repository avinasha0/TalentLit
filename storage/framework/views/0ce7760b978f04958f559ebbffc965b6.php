            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-center mb-8">
                        <h1 class="text-3xl font-bold text-gray-900">Welcome to <?php echo e($tenant->name); ?>!</h1>
                        <p class="mt-2 text-sm text-gray-600">Let's complete your setup to get started with hiring</p>
                    </div>

                    <form method="POST" action="<?php echo e(route('onboarding.setup.store', $tenant->slug)); ?>" class="space-y-8">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/onboarding/setup.blade.php ENDPATH**/ ?>