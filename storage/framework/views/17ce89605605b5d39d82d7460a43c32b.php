...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" action="<?php echo e(route('verification.verify')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>