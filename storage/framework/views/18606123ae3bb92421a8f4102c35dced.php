...
<div class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <form id="footer-newsletter-form-duplicate" method="POST" action="<?php echo e(route('newsletter.subscribe')); ?>" class="max-w-md mx-auto">
                <?php echo csrf_field(); ?>
    ...
    footerFormDuplicate.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (response.ok && data.requires_verification) {
                ...
                window.location.href = '<?php echo e(route("newsletter.subscribe")); ?>';
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\components\newsletter-footer-duplicate.blade.php ENDPATH**/ ?>