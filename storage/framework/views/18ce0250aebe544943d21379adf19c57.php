                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center text-sm text-black">
                                            ...
                                            <span class="truncate"><?php echo e($job->location?->name ?? $job->globalLocation?->name ?? $job->city?->formatted_location ?? 'No location specified'); ?></span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1 flex items-center space-x-4 text-sm text-black">
                                                ...
                                                <span class="flex items-center">
                                                    ...
                                                    <?php echo e($job->location?->name ?? $job->globalLocation?->name ?? $job->city?->formatted_location ?? 'No location specified'); ?>
