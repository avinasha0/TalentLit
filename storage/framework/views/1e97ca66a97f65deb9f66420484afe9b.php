<?php $__env->startSection('title', 'Contact Support — TalentLit Help'); ?>
<?php $__env->startSection('description', 'Get in touch with TalentLit support team. Find contact information, support hours, and how to report issues.'); ?>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li><a href="<?php echo e(route('help.page', 'troubleshooting')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Troubleshooting Guide</a></li>
                                        <li><a href="<?php echo e(route('help.page', 'faq')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Frequently Asked Questions</a></li>
                                    </ul>
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\help\contact.blade.php ENDPATH**/ ?>