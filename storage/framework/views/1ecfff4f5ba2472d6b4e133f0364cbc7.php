...
<?php $component->withAttributes([]); ?>
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 <?php echo e($info['color']); ?> rounded-lg flex items-center justify-center">
                                <?php if($info['icon'] === 'crown'): ?>
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                <?php elseif($info['icon'] === 'shield-check'): ?>
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                <?php elseif($info['icon'] === 'user-group'): ?>
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-black truncate"><?php echo e($role->name); ?></dt>
                                <dd class="text-sm text-gray-600"><?php echo e($info['description']); ?></dd>
                            </dl>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e($role->name); ?></th>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <?php $__currentLoopData = $permissionCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="bg-gray-50">
                                <td colspan="<?php echo e($roles->count() + 1); ?>" class="px-6 py-3 text-sm font-medium text-gray-900 bg-gray-100">
                                    <?php echo e($category); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/tenant/settings/roles.blade.php ENDPATH**/ ?>