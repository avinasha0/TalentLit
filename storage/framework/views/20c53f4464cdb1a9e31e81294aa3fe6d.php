<?php $__env->startSection('title', 'Roles & Permissions — TalentLit Help'); ?>
<?php $__env->startSection('description', 'Learn about user roles and permissions in TalentLit ATS, how to assign roles, and manage team access effectively.'); ?>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li><a href="<?php echo e(route('help.page', 'invite-team')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Team Invitations</a></li>
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/help/roles-permissions.blade.php ENDPATH**/ ?>