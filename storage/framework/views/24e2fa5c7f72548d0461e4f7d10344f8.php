<?php $__env->startSection('title', 'Payment Successful - TalentLit'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-900"><?php echo e($subscription->subscriptionPlan->name); ?></span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-900">
                                ₹<?php echo e(number_format($subscription->amount_paid, 2)); ?>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-900">
                                <?php echo e(ucfirst($subscription->payment_method)); ?>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-900">
                                <?php echo e($subscription->expires_at->format('M d, Y')); ?>
            ...
            <!-- Action Buttons -->
            <div class="space-y-4">
                <a href="<?php echo e(route('tenant.dashboard', $subscription->tenant->slug ?? '')); ?>" 
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\payment\success.blade.php ENDPATH**/ ?>