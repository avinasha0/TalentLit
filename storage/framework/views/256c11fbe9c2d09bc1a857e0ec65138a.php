...
<div data-mobile-drawer class="fixed top-0 left-0 w-64 h-full bg-white border-r border-gray-300 transform -translate-x-full transition-transform duration-300 lg:hidden flex flex-col">
    ...
    <nav class="flex-1 overflow-y-auto p-4">
        ...
        <div class="space-y-2">
            ...
            <a href="<?php echo e(tenantRoute('tenant.tasks.my', $tenant->slug ?? tenant()->slug)); ?>" class="block py-2 text-gray-700 hover:text-blue-600">My Tasks</a>
                ...
                <div data-mobile-recruiting-content class="ml-4 space-y-1 hidden">
                    ...
                    <div class="mt-2">
                        ...
                        <div data-mobile-requisitions-content class="ml-4 space-y-1 hidden">
                            <a href="<?php echo e(tenantRoute('tenant.requisitions.index', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">All Requisitions</a>
                            <a href="<?php echo e(tenantRoute('tenant.requisitions.create', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Create Requisition</a>
                            <a href="<?php echo e(tenantRoute('tenant.requisitions.pending', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Pending Approvals</a>
                            <a href="<?php echo e(tenantRoute('tenant.requisitions.approved', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Approved Requisitions</a>
                            <a href="<?php echo e(tenantRoute('tenant.requisitions.rejected', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Rejected Requisitions</a>
                        </div>
                    </div>
            ...
            <div class="mt-4">
                ...
                <div data-mobile-onboarding-content class="ml-4 space-y-1 hidden">
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.pre-onboarding', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Pre Onboarding</a>
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.all', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">All Onboardings</a>
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.new', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">New Onboarding</a>
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.tasks', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Tasks</a>
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.documents', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Documents</a>
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.it-assets', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">IT & Assets</a>
                    <a href="<?php echo e(tenantRoute('tenant.employee-onboarding.approvals', $tenant->slug ?? tenant()->slug)); ?>" class="block py-1 text-gray-700 hover:text-blue-600">Approvals</a>
                </div>
            </div>
