<?php $__env->startSection('title', 'Help Center — TalentLit'); ?>
<?php $__env->startSection('description', 'Get help with TalentLit ATS. Find guides, tutorials, and support for managing your recruitment process.'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8" id="helpCategories">
                ...
                <div class="help-card bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-100 hover:shadow-xl transition-all duration-300" data-search="getting started register login onboarding account setup team invite">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('help.page', 'register')); ?>" class="block text-indigo-600 hover:text-indigo-700 font-medium">How to Register</a>
                        <a href="<?php echo e(route('help.page', 'login')); ?>" class="block text-indigo-600 hover:text-indigo-700 font-medium">How to Login</a>
                        <a href="<?php echo e(route('help.page', 'onboarding')); ?>" class="block text-indigo-600 hover:text-indigo-700 font-medium">Account Setup</a>
                        <a href="<?php echo e(route('help.page', 'invite-team')); ?>" class="block text-indigo-600 hover:text-indigo-700 font-medium">Invite Your Team</a>
                    </div>
                </div>
                ...
                <div class="help-card bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl border border-purple-100 hover:shadow-xl transition-all duration-300" data-search="job management create post publish careers applications">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('help.page', 'jobs')); ?>" class="block text-purple-600 hover:text-purple-700 font-medium">Managing Jobs</a>
                        <a href="<?php echo e(route('help.page', 'careers')); ?>" class="block text-purple-600 hover:text-purple-700 font-medium">Career Pages</a>
                        <a href="<?php echo e(route('help.page', 'applications')); ?>" class="block text-purple-600 hover:text-purple-700 font-medium">Application Management</a>
                    </div>
                </div>
                ...
                <div class="help-card bg-gradient-to-br from-pink-50 to-red-50 p-8 rounded-2xl border border-pink-100 hover:shadow-xl transition-all duration-300" data-search="candidate management pipeline notes tags organize track">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('help.page', 'candidates')); ?>" class="block text-pink-600 hover:text-pink-700 font-medium">Managing Candidates</a>
                        <a href="<?php echo e(route('help.page', 'pipeline')); ?>" class="block text-pink-600 hover:text-pink-700 font-medium">Hiring Pipeline</a>
                        <a href="<?php echo e(route('help.page', 'notes-tags')); ?>" class="block text-pink-600 hover:text-pink-700 font-medium">Notes & Tags</a>
                    </div>
                </div>
                ...
                <div class="help-card bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border border-blue-100 hover:shadow-xl transition-all duration-300" data-search="interviews schedule manage dashboard">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('help.page', 'interviews')); ?>" class="block text-blue-600 hover:text-blue-700 font-medium">Scheduling Interviews</a>
                        <a href="<?php echo e(route('help.page', 'dashboard')); ?>" class="block text-blue-600 hover:text-blue-700 font-medium">Dashboard Overview</a>
                    </div>
                </div>
                ...
                <div class="help-card bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl border border-green-100 hover:shadow-xl transition-all duration-300" data-search="analytics reports dashboard metrics performance">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('help.page', 'analytics')); ?>" class="block text-green-600 hover:text-green-700 font-medium">Analytics Dashboard</a>
                    </div>
                </div>
                ...
                <div class="help-card bg-gradient-to-br from-gray-50 to-slate-50 p-8 rounded-2xl border border-gray-100 hover:shadow-xl transition-all duration-300" data-search="settings admin roles permissions integrations configure">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('help.page', 'settings')); ?>" class="block text-gray-600 hover:text-gray-700 font-medium">Account Settings</a>
                        <a href="<?php echo e(route('help.page', 'roles-permissions')); ?>" class="block text-gray-600 hover:text-gray-700 font-medium">Roles & Permissions</a>
                        <a href="<?php echo e(route('help.page', 'integrations')); ?>" class="block text-gray-600 hover:text-gray-700 font-medium">Integrations</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8" id="popularArticles">
                <div class="help-card bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow" data-search="getting started guide walkthrough new users">
                    ...
                    <a href="<?php echo e(route('help.page', 'onboarding')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Read more →</a>
                </div>
                ...
                <div class="help-card bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow" data-search="creating first job posting tutorial step by step">
                    ...
                    <a href="<?php echo e(route('help.page', 'jobs')); ?>" class="text-purple-600 hover:text-purple-700 font-medium">Read more →</a>
                </div>
                ...
                <div class="help-card bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow" data-search="managing candidates organize track applicants effectively">
                    ...
                    <a href="<?php echo e(route('help.page', 'candidates')); ?>" class="text-pink-600 hover:text-pink-700 font-medium">Read more →</a>
                </div>
                ...
                <div class="help-card bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow" data-search="scheduling interviews set up manage schedules">
                    ...
                    <a href="<?php echo e(route('help.page', 'interviews')); ?>" class="text-blue-600 hover:text-blue-700 font-medium">Read more →</a>
                </div>
                ...
                <div class="help-card bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow" data-search="analytics overview understanding hiring metrics">
                    ...
                    <a href="<?php echo e(route('help.page', 'analytics')); ?>" class="text-green-600 hover:text-green-700 font-medium">Read more →</a>
                </div>
                ...
                <div class="help-card bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow" data-search="troubleshooting common issues solutions problems">
                    ...
                    <a href="<?php echo e(route('help.page', 'troubleshooting')); ?>" class="text-red-600 hover:text-red-700 font-medium">Read more →</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('help.page', 'contact')); ?>" 
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/help/index.blade.php ENDPATH**/ ?>