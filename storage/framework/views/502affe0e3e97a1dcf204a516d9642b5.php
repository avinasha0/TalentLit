                            ...
                            <div class="grid grid-cols-2 gap-8 px-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <a href="<?php echo e(route('features.job-advertising')); ?>" class="block px-3 py-2 text-sm text-indigo-600 bg-indigo-50 rounded-md transition-colors duration-200">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
                    ...
                    <div class="px-3 py-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('features.job-advertising')); ?>" class="block px-3 py-2 text-base text-indigo-600 bg-indigo-50 rounded-md">
                                Job Advertising
                            </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('features.candidate-sourcing')); ?>" class="text-gray-400 hover:text-white transition-colors">Candidate Sourcing</a></li>
                        <li><a href="<?php echo e(route('features.hiring-pipeline')); ?>" class="text-gray-400 hover:text-white transition-colors">Hiring Pipeline</a></li>
                        <li><a href="<?php echo e(route('features.career-site')); ?>" class="text-gray-400 hover:text-white transition-colors">Career Site</a></li>
                        <li><a href="<?php echo e(route('features.job-advertising')); ?>" class="text-gray-400 hover:text-white transition-colors">Job Advertising</a></li>
                        <li><a href="<?php echo e(route('subscription.pricing')); ?>" class="text-gray-400 hover:text-white transition-colors">Pricing</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo e(route('careers')); ?>" class="text-gray-400 hover:text-white transition-colors">Careers</a></li>
                        <li><a href="<?php echo e(route('blog')); ?>" class="text-gray-400 hover:text-white transition-colors">Blog</a></li>
                        <li><a href="<?php echo e(route('press')); ?>" class="text-gray-400 hover:text-white transition-colors">Press</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('help-center.html')); ?>" class="text-gray-400 hover:text-white transition-colors">Help Center</a></li>
                        <li><a href="<?php echo e(route('documentation.html')); ?>" class="text-gray-400 hover:text-white transition-colors">Documentation</a></li>
                        <li><a href="<?php echo e(route('community.html')); ?>" class="text-gray-400 hover:text-white transition-colors">Community</a></li>
                        <li><a href="<?php echo e(route('status.html')); ?>" class="text-gray-400 hover:text-white transition-colors">Status</a></li>
                        <li><a href="<?php echo e(route('security.html')); ?>" class="text-gray-400 hover:text-white transition-colors">Security</a></li>
                    </ul>
                </div>
            </div>
...
<?php endif; ?>
                    ...
                    <div id="newsletter-success" class="hidden mt-4 p-4 bg-green-600 text-white rounded-lg">
                        <p class="font-semibold">🎉 Thank you for subscribing!</p>
                        <p class="text-sm">You'll receive our latest updates and recruitment tips.</p>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/features/job-advertising.blade.php ENDPATH**/ ?>