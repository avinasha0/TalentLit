...
<head>
    ...
    <title>Jobs - <?php echo e($tenant->name); ?></title>
                    ...
                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h2 class="text-xl font-semibold text-gray-900"><?php echo e($job->title); ?></h2>
                                ...
                                <div class="text-right">
                                    <div class="text-2xl font-bold text-gray-900"><?php echo e($job->openings_count); ?></div>
                                    <div class="text-sm text-gray-600">Openings</div>
                                </div>
                            </div>
                            
                            <?php if($job->description): ?>
                                <p class="text-gray-700 mb-4"><?php echo e(Str::limit($job->description, 200)); ?></p>
                            <?php endif; ?>
                            
                            <div class="flex justify-between items-center">
                                <div class="text-sm text-gray-500">
                                    Published: <?php echo e(\Carbon\Carbon::parse($job->published_at)->format('M d, Y')); ?>
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\tenant\jobs.blade.php ENDPATH**/ ?>