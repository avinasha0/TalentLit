                            ...
                            <div class="grid grid-cols-2 gap-8 px-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <a href="<?php echo e(route('features.manage-submission')); ?>" class="block px-3 py-2 text-sm text-indigo-600 bg-indigo-50 rounded-md transition-colors duration-200">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
                    ...
                    <div class="px-3 py-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('features.manage-submission')); ?>" class="block px-3 py-2 text-base text-indigo-600 bg-indigo-50 rounded-md">
                                Manage Submission
                            </a>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="<?php echo e(route('features.resume-management')); ?>" class="hover:text-white">Resume Management</a></li>
                        <li><a href="<?php echo e(route('features.manage-submission')); ?>" class="hover:text-white">Manage Submission</a></li>
                        <li><a href="<?php echo e(route('features.hiring-analytics')); ?>" class="hover:text-white">Hiring Analytics</a></li>
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/features/manage-submission.blade.php ENDPATH**/ ?>