...
<head>
    ...
    <title>Candidates - <?php echo e($tenant->name); ?></title>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="/<?php echo e($tenant->slug); ?>/dashboard" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                        Back to Dashboard
                    </a>
                </div>
            </div>
            ...
            <?php if(count($candidates) > 0): ?>
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <div class="flex items-center space-x-3 mb-2">
                                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e($candidate->name); ?></h3>
                                    ...
                                    <?php if(count($candidate->tags) > 0): ?>
                                        <div class="flex flex-wrap gap-2 mb-3">
                                            <?php $__currentLoopData = $candidate->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="px-2 py-1 rounded-full text-xs font-medium" style="background-color: <?php echo e($tag->color); ?>20; color: <?php echo e($tag->color); ?>">
                                                    <?php echo e($tag->name); ?>
                                    ...
                                    <div class="text-xs text-gray-500">
                                        Added: <?php echo e(\Carbon\Carbon::parse($candidate->created_at)->format('M d, Y')); ?>
                ...
                <div class="mt-6 flex justify-between items-center">
                    <div class="text-sm text-gray-700">
                        Showing <?php echo e(count($candidates)); ?> candidates
                    </div>
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\tenant\candidates.blade.php ENDPATH**/ ?>