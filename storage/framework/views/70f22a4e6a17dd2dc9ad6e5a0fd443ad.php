<?php $__env->startSection('title', 'Managing Candidates — TalentLit Help'); ?>
<?php $__env->startSection('description', 'Learn how to manage candidates, view profiles, add notes and tags, and organize your talent pipeline in TalentLit.'); ?>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li><a href="<?php echo e(route('help.page', 'interviews')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Scheduling Interviews</a></li>
                                        <li><a href="<?php echo e(route('help.page', 'notes-tags')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Notes & Tags Guide</a></li>
                                    </ul>
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\help\candidates.blade.php ENDPATH**/ ?>