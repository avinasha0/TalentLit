                                ...
                                <div class="border border-gray-200 rounded-lg p-6 hover:bg-gray-50">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div class="ml-4 flex space-x-2">
                                            <a href="<?php echo e(route('tenant.jobs.show', ['tenant' => $tenantSlug, 'job' => $application->jobOpening])); ?>" 
                                               class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                                View Job
                                            </a>
                                        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/tenant/candidates/show.blade.php ENDPATH**/ ?>