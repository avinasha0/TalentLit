...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Your application status has been updated at <?php echo e($tenant->name); ?>!</p>
        </div>

        <div class="content">
            <p>Dear <?php echo e($candidate->first_name); ?> <?php echo e($candidate->last_name); ?>,</p>

            <p>We wanted to inform you that your application for the position of <strong><?php echo e($job->title); ?></strong> has been moved to a new stage in our recruitment process.</p>

            <div class="stage-info">
                <h3>Current Status</h3>
                <p><strong>Stage:</strong> <?php echo e($stage->name); ?></p>
                <p><strong>Position:</strong> <?php echo e($job->title); ?></p>
                <p><strong>Company:</strong> <?php echo e($tenant->name); ?></p>
                <p><strong>Updated On:</strong> <?php echo e(now()->format('F j, Y \a\t g:i A')); ?></p>
            </div>
            ...
            <p>Thank you for your continued interest in <?php echo e($tenant->name); ?>!</p>
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\emails\stage-changed.blade.php ENDPATH**/ ?>