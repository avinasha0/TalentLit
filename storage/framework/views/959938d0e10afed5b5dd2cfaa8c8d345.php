<?php $__env->startSection('title', 'Troubleshooting — TalentLit Help'); ?>
<?php $__env->startSection('description', 'Common issues and solutions for TalentLit ATS. Find quick fixes for login, performance, and technical problems.'); ?>
                                ...
                                <div>
                                    ...
                                    <div class="bg-white p-4 rounded-lg">
                                        ...
                                        <ol class="list-decimal list-inside space-y-2 text-gray-600">
                                            ...
                                            <li>Try visiting <code class="bg-gray-100 px-2 py-1 rounded text-sm"><?php echo e(url('/logout')); ?></code> directly</li>
                                            <li>Clear your browser cache and cookies</li>
                                ...
                                <div>
                                    ...
                                    <div class="bg-white p-4 rounded-lg">
                                        ...
                                        <ul class="space-y-2 text-gray-600">
                                            <li>• <a href="<?php echo e(route('help.page', 'contact')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Contact Support Form</a></li>
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/help/troubleshooting.blade.php ENDPATH**/ ?>