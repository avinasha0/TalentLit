...
<?php endif; ?>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-white"><?php echo e($template->name); ?></h1>
                <p class="mt-1 text-sm text-white">
                    <?php echo e($template->type_name); ?> template
                </p>
            </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($template->type_name); ?></p>
                            </div>
                        </div>
                        <div class="text-sm text-gray-500">
                            Created <?php echo e($template->created_at->diffForHumans()); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 p-4 bg-gray-50 rounded-md">
                                <div class="text-sm text-gray-900 whitespace-pre-wrap"><?php echo e($template->body); ?></div>
                            </div>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
    ...
    <script>
        function previewTemplate() {
            fetch(`/<?php echo e($tenant->slug); ?>/email-templates/<?php echo e($template->id); ?>/preview`, {
                headers: {
        ...
        function duplicateTemplate() {
            if (confirm('Are you sure you want to duplicate this template?')) {
                window.location.href = `/<?php echo e($tenant->slug); ?>/email-templates/<?php echo e($template->id); ?>/duplicate`;
            }
        }
    </script>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\tenant\email-templates\show.blade.php ENDPATH**/ ?>