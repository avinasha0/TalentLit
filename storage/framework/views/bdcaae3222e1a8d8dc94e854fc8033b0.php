        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="<?php echo e(route('tenant.locations.create', $tenant->slug)); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            + Add Location
                        </a>
                    </div>
                </div>
                ...
                <form method="GET" class="mt-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Search by name or code" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
            ...
            <div class="block lg:hidden space-y-4">
                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-base font-semibold text-black"><?php echo e($location->name); ?></p>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black"><?php echo e($location->name); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black"><?php echo e($location->code ?? '—'); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/tenant/locations/index.blade.php ENDPATH**/ ?>