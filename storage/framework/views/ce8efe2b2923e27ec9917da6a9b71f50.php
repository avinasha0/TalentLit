<?php $__env->startSection('title', 'Account Settings — TalentLit Help'); ?>
<?php $__env->startSection('description', 'Learn how to configure your TalentLit account settings, manage team members, and customize your organization preferences.'); ?>
                        ...
                        <div id="related-topics" class="bg-indigo-50 p-8 rounded-lg">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        <li><a href="<?php echo e(route('help.page', 'roles-permissions')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Roles & Permissions</a></li>
                                        ...
                                        <li><a href="<?php echo e(route('help.page', 'security')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium">Security Guide</a></li>
                                    </ul>
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.help', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/help/settings.blade.php ENDPATH**/ ?>