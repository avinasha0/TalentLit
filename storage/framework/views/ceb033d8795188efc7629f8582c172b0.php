...
<?php $component->withAttributes([]); ?>
            <form method="POST" action="<?php echo e(route('tenant.jobs.update', ['tenant' => $tenant->slug, 'job' => $job->id])); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text"
                           name="slug"
                           id="slug"
                           value="<?php echo e(old('slug', $job->slug)); ?>"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                           placeholder="e.g., senior-software-engineer">
                    ...
                    <div>
                        ...
                        <select name="department_id"
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($department->id); ?>" <?php echo e(old('department_id', $job->department_id) == $department->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select name="employment_type"
                            ...
                            <?php $__currentLoopData = $employmentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type); ?>" <?php echo e(old('employment_type', $job->employment_type) == $type ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="openings_count"
                               id="openings_count"
                               value="<?php echo e(old('openings_count', $job->openings_count)); ?>"
                               min="1"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
                        <?php $__errorArgs = ['openings_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views\tenant\jobs\edit.blade.php ENDPATH**/ ?>