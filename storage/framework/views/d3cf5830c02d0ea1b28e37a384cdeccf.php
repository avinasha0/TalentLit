...
<?php $component->withAttributes([]); ?>
            <form method="POST" action="<?php echo e(route('tenant.jobs.store', $tenant->slug)); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <a href="<?php echo e(route('tenant.departments.create', $tenant->slug)); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">+ Add Department</a>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="openings_count"
                               id="openings_count"
                               value="<?php echo e(old('openings_count', 1)); ?>"
                               min="1"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/tenant/jobs/create.blade.php ENDPATH**/ ?>