                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" 
                                ...
                                class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                            <button type="button" 
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="text-gray-700">
                                I agree to the 
                                <a href="<?php echo e(route('terms-of-service')); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-500 font-medium">Terms of Service</a> 
                                and 
                                <a href="<?php echo e(route('privacy-policy')); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-500 font-medium">Privacy Policy</a>
                            </label>
                        </div>
                    </div>
