        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="<?php echo e(route('shipping-delivery')); ?>" class="text-gray-400 hover:text-white transition-colors text-sm">Shipping</a></li>
                    <li><a href="<?php echo e(route('cancellation-refund-policy')); ?>" class="text-gray-400 hover:text-white transition-colors text-sm">Refunds</a></li>
...
<?php /**PATH C:\xampp\htdocs\hirehub2\resources\views/components/footer.blade.php ENDPATH**/ ?>